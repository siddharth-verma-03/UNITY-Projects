...
public class GameStart : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameObject.FindGameObjectWithTag("Timer").GetComponent<TimeCalc>().textMeshProUGUI.text = highScore + " ";
    ...
    public void GameShuru()
    {
        ...
        ApplyAudioSettings(); // Ensure audio settings persist on restart
    }
    ...
    public void GameShuruInter()
    {
        ...
        ApplyAudioSettings(); // Keep audio settings intact
    }
    ...
    public void GameShuruAfterAD()
    {
        ...
        ApplyAudioSettings(); // Keep audio settings after ad
    }
